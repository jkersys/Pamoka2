...
namespace P04EFApplyingToAPI.Migrations
{
    ...
    [Migration("20221207164620_AddedLocalUsersTable")]
            ...
            modelBuilder.Entity("P04_EF_Applying_To_API.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 7, 18, 46, 19, 621, DateTimeKind.Local).AddTicks(8691),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 7, 18, 46, 19, 621, DateTimeKind.Local).AddTicks(8750),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 7, 18, 46, 19, 621, DateTimeKind.Local).AddTicks(8842),
                            ImagePath = "",
                            Name = "Kibinai",
                            SpiceLevel = "Low",
                            Type = "Street food",
