...
namespace P04EFApplyingToAPI.Migrations
{
    ...
    [Migration("20221124154354_InitialMigrationDataSeed")]
            ...
            modelBuilder.Entity("P04_EF_Applying_To_API.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 11, 24, 17, 43, 53, 727, DateTimeKind.Local).AddTicks(8851),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 11, 24, 17, 43, 53, 727, DateTimeKind.Local).AddTicks(8900),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 11, 24, 17, 43, 53, 727, DateTimeKind.Local).AddTicks(8904),
                            ImagePath = "",
                            Name = "Kibinai",
                            SpiceLevel = "Low",
                            Type = "Street food"
