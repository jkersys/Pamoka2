...
namespace P04EFApplyingToAPI.Migrations
{
    ...
    [Migration("20221215165634_AddDishOrder")]
    partial class AddDishOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("P04_EF_Applying_To_API.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 15, 18, 56, 33, 727, DateTimeKind.Local).AddTicks(1497),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 15, 18, 56, 33, 727, DateTimeKind.Local).AddTicks(1546),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 15, 18, 56, 33, 727, DateTimeKind.Local).AddTicks(1550),
                            ImagePath = "",
                            Name = "Kibinai",
                            SpiceLevel = "Low",
                            Type = "Street food",
