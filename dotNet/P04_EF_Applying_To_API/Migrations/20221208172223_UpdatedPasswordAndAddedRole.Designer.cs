...
namespace P04EFApplyingToAPI.Migrations
{
    ...
    [Migration("20221208172223_UpdatedPasswordAndAddedRole")]
    partial class UpdatedPasswordAndAddedRole
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("P04_EF_Applying_To_API.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 8, 19, 22, 23, 337, DateTimeKind.Local).AddTicks(6523),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 8, 19, 22, 23, 337, DateTimeKind.Local).AddTicks(6581),
                            ImagePath = "",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 8, 19, 22, 23, 337, DateTimeKind.Local).AddTicks(6589),
                            ImagePath = "",
                            Name = "Kibinai",
                            SpiceLevel = "Low",
                            Type = "Street food",
